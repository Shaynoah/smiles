      ...
      >
        ...
        <div className="footer-top">
          ...
          <motion.div className="footer-logo-section" variants={itemVariants}>
            ...
            <motion.p
              ...
              variants={itemVariants}
            >
              Transforming smiles with precision, innovation, and excellence in dental implant technology.
            </motion.p>
          </motion.div>
        ...
        >
          ...
          <div className="footer-copyright">
            ...
            >
              © {new Date().getFullYear()} SmileSmith Ltd. All rights reserved.
            </motion.p>
            <motion.div
